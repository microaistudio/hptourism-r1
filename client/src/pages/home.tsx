  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className={`${theme !== 'classic-clean' ? 'relative' : ''} max-w-6xl mx-auto text-center`}>
          <h1 className={`text-3xl md:text-4xl font-bold mb-6 whitespace-nowrap ${theme !== 'classic-clean' ? 'text-white' : 'text-foreground'}`}>
