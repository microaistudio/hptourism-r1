...
const QUERY_TEMPLATES = {
  ...
  "LGD: All Districts (12)": "SELECT * FROM lgd_districts ORDER BY name;",
  "LGD: All Tehsils": "SELECT * FROM lgd_tehsils ORDER BY name LIMIT 50;",
  "LGD: All Blocks": "SELECT * FROM lgd_blocks ORDER BY name LIMIT 50;",
  "LGD: All Gram Panchayats": "SELECT * FROM lgd_gram_panchayats ORDER BY name LIMIT 50;",
  "LGD: All Urban Bodies": "SELECT * FROM lgd_urban_bodies ORDER BY name LIMIT 50;",
  "LGD: Full Hierarchy Counts": "SELECT 'Districts' as level, COUNT(*) as count FROM lgd_districts UNION ALL SELECT 'Tehsils', COUNT(*) FROM lgd_tehsils UNION ALL SELECT 'Blocks', COUNT(*) FROM lgd_blocks UNION ALL SELECT 'Gram Panchayats', COUNT(*) FROM lgd_gram_panchayats UNION ALL SELECT 'Urban Bodies', COUNT(*) FROM lgd_urban_bodies;",
